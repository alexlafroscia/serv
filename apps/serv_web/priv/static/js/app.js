...
exports.default = class extends _preact.Component {
  constructor() {
    super();
  ...
  onDragEnter(event) {
    ...
    this.setState({
      isReceiving: Array.from(event.dataTransfer.items).filter(item => item.kind === 'file').length > 0
    });
  }
  ...
  uploadFiles(event) {
    ...
    return Promise.all(this.state.files.map(file => {
      ...
      return (0, _fetch2.default)('/upload', {
        method: 'POST',
        body: form
      });
    })).then(() => {
  ...
  render({ children }, { files, isReceiving }) {
    ...
    return (0, _preact.h)(
      ...
      files.length ? (0, _preact.h)(
        ...
        (0, _preact.h)(
          'button',
          { 'class': 'btn btn-primary', onClick: uploadFiles },
          'Upload'
        )
      ) : undefined,
      children
...
exports.default = ({ children, linkHref = '#', fileHref, title, detailText }) => {
  return (0, _preact.h)(
    'div',
    {
      style: {
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        ...
        detailText ? (0, _preact.h)(
          'div',
          { style: { color: 'grey' } },
          detailText
        ) : undefined
      ),
      fileHref ? (0, _preact.h)(
        'a',
        { href: fileHref },
        'View File'
      ) : undefined
...
var _ensureAuthenticated = __webpack_require__(10);
...
const Main = () => (0, _preact.h)(
  _ensureAuthenticated2.default,
  null,
  (0, _preact.h)(
    _preactRouter2.default,
    null,
    (0, _preact.h)(_files2.default, { path: '/ui' }),
    (0, _preact.h)(_file2.default, { path: '/ui/:fileId' }),
    (0, _preact.h)(_instance2.default, { path: '/ui/:fileId/:instanceId' })
  )
);

(0, _preact.render)((0, _preact.h)(Main, null), document.getElementById('preact-router-anchor'));
...
var _linkstate = __webpack_require__(11);
...
class EnsureAuthenticatedComponent extends _preact.Component {
  constructor() {
    super();
  ...
  checkAuthenticated(password) {
    ...
    return (0, _fetch2.default)('/api/authenticated', {
      headers: {
  ...
  render({ children }, { isAuthenticated, password }) {
    ...
    if (isAuthenticated) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { 'class': 'input-group', style: { maxWidth: '300px' } },
          (0, _preact.h)('input', {
            type: 'text',
            'class': 'form-control',
            value: password,
            placeholder: 'Password',
            onKeyUp: (0, _linkstate2.default)(this, 'password')
          }),
          (0, _preact.h)(
            'span',
...
exports.default = EnsureAuthenticatedComponent;
...
exports.default = class extends _preact.Component {
  ...
  componentWillMount() {
    (0, _fetch2.default)('/api/files').then(res => res.json()).then(({ data: files }) => {
      this.setState({ files });
    });
  }
    ...
    return (0, _preact.h)(
      ...
      (0, _preact.h)(
        ...
        files.map(file => {
          ...
          return (0, _preact.h)(_listItem2.default, {
            title: fileName,
            linkHref: `/ui/${file.id}`,
            fileHref: `/${fileName}`
          });
...
var _fileName = __webpack_require__(7);
...
exports.default = class extends _preact.Component {
  ...
  fetchData() {
    ...
    (0, _fetch2.default)(`/api/files/${fileId}?include=instances,tags`).then(res => res.json()).then(({ data, included = [] }) => {
      const tagMap = included.filter(inc => inc.type === 'tags').reduce((acc, tag) => {
  ...
  updateTag(instance) {
    return event => {
      ...
      (0, _fetch2.default)(`/api/tags/${tag.id}/relationships/instance`, {
        method: 'PATCH',
        body: JSON.stringify({
          data: {
            type: 'instances',
  ...
  render(_, { file, instances, tags }) {
    const name = (0, _fileName2.default)(file);
    ...
    return (0, _preact.h)(
      ...
      (0, _preact.h)(
        ...
        instances.map(instance => (0, _preact.h)(
          'div',
          { onDrop: this.updateTag(instance) },
          (0, _preact.h)(
            _listItem2.default,
            {
              title: instance.attributes.hash,
              detailText: (0, _formatDate2.default)(instance.attributes['created-at']),
              linkHref: `/ui/${file.id}/${instance.id}`,
              fileHref: `/${name}?${instance.attributes.hash}`
            },
            tags[instance.id] ? (0, _preact.h)(
              'div',
              null,
              'Tags:',
              tags[instance.id].map(tag => (0, _preact.h)(_tag2.default, { tag: tag, draggable: true }))
            ) : undefined
          )
        ))
      )
...
class Tag extends _preact.Component {
...
exports.default = class extends _preact.Component {
  ...
  componentWillMount() {
    ...
    (0, _fetch2.default)(`/api/files/${fileId}?include=instances`).then(res => res.json()).then(({ data, included = [] }) => {
      this.setState({
        file: data,
        instance: included.filter(data => data.type === 'instances').find(data => data.id == instanceId)
      });
    });
  }
      ...
      (0, _preact.h)(
        ...
        file && instance ? (0, _preact.h)(
            ...
            (0, _preact.h)(
              ...
              (0, _preact.h)(
                ...
                (0, _preact.h)(
                  ...
                  (0, _formatDate2.default)(instance.attributes['created-at'])
                )
              )
            )
          ),
          (0, _preact.h)('iframe', {
            ...
            src: `/${(0, _fileName2.default)(file)}?${instance.attributes.hash}`
          })
        ) : undefined
      )
    );
